      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
              <a class="btn btn-primary btn-round text-white pull-right" href="{{route('users.add-user')}}">Add user</a>
              ...
              <tbody>
                @foreach($users as $user)
                    ...
                    <td>{{$user->role->role}}</td>
                      <td class="text-right">
                      <form method="POST" action="{{route('users.action', ['user_id' => $user->id])}}" autocomplete="off"
