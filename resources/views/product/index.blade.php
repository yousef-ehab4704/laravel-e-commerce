      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
              <a class="btn btn-primary btn-round text-white pull-right" href="{{route('product.add_product')}}">Add products</a>
            ...
            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
              ...
              <tbody>
                 ...
                 @foreach($products as $product) 
                  <tr>
                    <td><a href = "{{route('product.edit', [ 'product_id' => $product->id ])}}" >{{$product->name}}</a></td>
